  ...
  Widget _buildUpcomingList() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return BookingCard(
          title: index == 1 ? "Deep Home Cleaning" : index == 2 ? "Emergency Plumbing" : "Electrical Repair",
          requestId: index == 1 ? "#88291" : index == 2 ? "#88292" : "#88293",
          imageUrl: index == 1 ? null : index == 0 ? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJ610ot-BgDuM9FyyP8Yruf8rmtPQ011DfZg&s" : "https://goendlessenergy.com/wp-content/uploads/emergency-plumber-fixing-a-pipe-1024x680.webp",
          date: index == 1 ? "June 24" : index == 2 ? "June 25" : "June 26",
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return PastBookingCard(
          title: index == 0 ? "House Painting" : index == 1 ? "Window Cleaning" : "Lawn Mowing",
          description: "Full interior painting for 3-bedroom apartment with premium finish.",
          date: "May 15, 2023",
          status: "COMPLETED",
          imageUrl: index == 1 ? "https://b2406121.smushcdn.com/2406121/wp-content/uploads/2025/05/wc-1-scaled.jpeg?lossy=1&strip=1&webp=1" :"https://media.istockphoto.com/id/1461683093/photo/man-painting-wall-with-light-blue-dye-indoors-back-view.jpg?s=612x612&w=0&k=20&c=TDg87xVDJh-VA4zVClGlMnqpdqTh2QcZ--raihCv9XU=",
          onRateService: () {},
          onRebook: () {},
        );
      },
